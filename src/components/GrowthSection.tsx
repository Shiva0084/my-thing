  ...
  return (
    ...
    >
      <div className="mx-auto max-w-md space-y-6">
        <p className="reveal font-heading text-xl text-white/80 md:text-2xl">
        ...
        <p className="reveal font-body text-sm leading-relaxed text-white/60 md:text-base">
          I want to become responsible.
        </p>
        <p className="reveal font-body text-sm leading-relaxed text-white/60 md:text-base">
          I want to become dependable.
        </p>
        <p className="reveal font-body text-sm leading-relaxed text-white/60 md:text-base">
          I want to become a gentleman.
        </p>
        <p className="reveal font-heading text-lg text-accent/80 md:text-xl">
          I want my actions to reflect my words.
        </p>
      </div>
    </section>
  );
